...
def cargar_y_limpiar_datos():
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                if not df.empty:
                    ...
                    # Variables numéricas de participantes
                    for col in [
                        "suma_hombres",
                        "suma_mujeres",
                        "suma_intersexuales",
    ...
    if dfs:
        ...
        # Anonimización PII (Eliminar datos sensibles)
        sensibles = [
            c
...
if df_base.empty:
    st.error("No se pudieron obtener los datos desde KoboToolbox.")
    st.stop()
